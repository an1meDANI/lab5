...
public class MainActivity extends AppCompatActivity {
    ...
    public void onclick_test(View view) {
        ...
        String[] items = {"Андрей", "Дмитрий", "Алексей", "Даниил"};
        ...
        builder.setMultiChoiceItems(items, checkItems, (dialog, which, isChecked) -> {
            ...
            if (currentItem == "Алексей") {
                Toast toast = Toast.makeText(getApplicationContext(), "Верно!", Toast.LENGTH_SHORT);
                toast.show();
            }
            else {
                Toast toast = Toast.makeText(getApplicationContext(), "Попробуй еще раз!", Toast.LENGTH_SHORT);
                toast.show();
            }
        });
        builder.show();
    ...
    public void onclick_notification(View view) {
        ...
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(getApplicationContext(), CHANEL_ID)
                        ...
                        .setContentTitle("Золотарев Даниил Андреевич")
                        .setContentText("Т-403901-НТ")
